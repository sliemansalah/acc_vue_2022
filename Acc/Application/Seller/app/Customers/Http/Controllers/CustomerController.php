...
namespace Acc\Seller\Customers\Http\Controllers;


use App\Http\Controllers\Controller;
use Acc\Domain\Core\Response;
use Acc\Domain\Seller\Customers\Services\CustomerService;
use Acc\Seller\Customers\Http\Requests\CustomerRequest;

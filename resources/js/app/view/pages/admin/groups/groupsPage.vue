<template>
    ...
    <div class="mt-3">
        ...
        <span>/</span>
        <label active>{{$t('Groups')}}</label>
    </div>
        <h4 class="mt-3">{{$t('Groups')}}</h4>
        ...
        methods: {
            ...
            deleteRow(idVal){
                this.$confirm(this.$t('DeleteConfirmMessage'), this.$t('DeleteConfirmTitle'), {
                    ...
                    this.$store.dispatch("groups/removeData", idVal)
                    .then(_ => {
            ...
            initData(filters) {
                this.$store
                .dispatch("groups/getData", filters)
                .then(res => {
            ...
            this.$store
                .dispatch("groups/updateStatus", JSON.stringify(sendData))
                .then(() => {
                    this.$notify.success({
                        duration: 3000,
                        message: this.$t("UpdatedSuccessfully"),

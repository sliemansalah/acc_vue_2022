<template>
    ...
    <div class="mt-3">
        ...
        <span>/</span>
        <label active>{{$t('ItemTypes')}}</label>
    </div>
        <h4 class="mt-3">{{$t('ItemTypes')}}</h4>
        ...
        methods: {
            ...
            deleteRow(idVal){
                this.$confirm(this.$t('DeleteConfirmMessage'), this.$t('DeleteConfirmTitle'), {
                    ...
                    this.$store.dispatch("itemTypes/removeData", idVal)
                    .then(_ => {
            ...
            initData(filters) {
                this.$store
                .dispatch("item_types/getDataPagination", filters)
                .then(res => {
            ...
            if (event.target.files.length) {
                ...
                this.$store
                .dispatch("item_types/updateData", this.addEditObj)
                .then(_ => {
                    this.$notify.success({
                        duration: 3000,
            ...
            this.$store
                .dispatch("item-types/updateStatus", JSON.stringify(sendData))
                .then(() => {
                    this.$notify.success({
                        duration: 3000,
                        message: this.$t("UpdatedSuccessfully"),

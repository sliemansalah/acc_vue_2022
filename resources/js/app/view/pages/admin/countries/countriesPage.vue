<template>
    ...
    <div class="mt-3">
        ...
        <span>/</span>
        <label active>{{$t('Countries')}}</label>
    </div>
        <h4 class="mt-3">{{$t('Countries')}}</h4>
        ...
        >
            ...
            <div class="row">
                ...
                <div class="form-group" 
                >
                    <label class="control-label">{{$t("ZipCode")}}</label>
        ...
        data() {
            return {
                ...
                fields: [
                    ...
                    { key: 'zip_code', label: this.$t('ZipCode'), sortable: true, sortDirection: 'desc' },
        ...
        methods: {
            ...
            deleteRow(idVal){
                this.$confirm(this.$t('DeleteConfirmMessage'), this.$t('DeleteConfirmTitle'), {
                    ...
                    this.$store.dispatch("countries/removeData", idVal)
                    .then(_ => {
            ...
            initData(filters) {
                this.$store
                .dispatch("countries/getDataPagination", filters)
                .then(res => {
            ...
            this.$store
                .dispatch("countries/updateStatus", JSON.stringify(sendData))
                .then(() => {
                    this.$notify.success({
                        duration: 3000,
                        message: this.$t("UpdatedSuccessfully"),

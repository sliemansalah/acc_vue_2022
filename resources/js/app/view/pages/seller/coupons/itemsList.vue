                ...
                <div>
                    <div v-if="!viewOnly" 
                     ...
                     <b-table show-empty 
                            ...
                            :bordered="true"
                            :striped="true"
                            :items="addEditObj.items"
                            :fields="fields"
                    >
                        <template v-slot:cell(exclude)="row" >
                            <b-checkbox v-model="row.item.exclude"></b-checkbox>
                        </template>
        ...
        data() {
            return {
                ...
                fields: [
                    ...
                    { key: 'exclude', label: this.$t('Exclude'), sortable: false },
            ...
            deleteRow(index){
                this.$confirm(this.$t('DeleteConfirmMessage'), this.$t('DeleteConfirmTitle'), {
                    ...
                    type: 'warning'
                        ...
                        this.addEditObj.items.splice(index,1);
                        this.$notify.success({
                            duration: 3000,
